package com.inhuman.scanner.stokopname.SharedPreferences;
...
public class Preferences {
    ...
    static final String DATA_LOGIN_USER = "data_login_user";
    ...
    public static void setResultDataLogin(Context context, String resultLogin){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(DATA_LOGIN_USER,resultLogin);
        editor.apply();
    }

    public static String getResultDataLogin(Context context){
        return getSharedPreference(context).getString(DATA_LOGIN_USER,"");
    }

    public static void clearResultDataLogin(Context context){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.remove(DATA_LOGIN_USER);
        editor.apply();
    }
    public static void setTokenLogin(Context context, String token){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
